...
public class InfoFilmController {
    ...
    void initialize() throws SQLException, FileNotFoundException {
        String filmId = ConnectedUserController.getSelectedOeuvreId();
        ResultSet resultSet = DataBaseController.getInfoFilm(filmId);
        ...
        duree.setText(resultSet.getString("duree"));
